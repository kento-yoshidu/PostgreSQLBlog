...
type ItemListQuery = { readonly allMicrocmsItem: { readonly group: ReadonlyArray<{ readonly edges: ReadonlyArray<{ readonly node: Pick<MicrocmsItem, 'id' | 'category' | 'name'> }> }> } };
