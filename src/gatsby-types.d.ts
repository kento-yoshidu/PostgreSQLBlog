...
type FrontmatterFieldSelector = {
  ...
  readonly seriesName: InputMaybe<FieldSelectorEnum>;
  readonly seriesSlug: InputMaybe<FieldSelectorEnum>;
...
type FrontmatterSortInput = {
  ...
  readonly seriesName: InputMaybe<SortOrderEnum>;
  readonly seriesSlug: InputMaybe<SortOrderEnum>;
...
type hogeQueryVariables = Exact<{ [key: string]: never; }>;


type hogeQuery = { readonly allMarkdownRemark: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly fields: { readonly slug: string | null } | null }> } };
